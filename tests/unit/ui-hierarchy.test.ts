...
<hierarchy rotation="0">
  <node index="0" class="android.widget.FrameLayout" package="com.example.app" bounds="[0,0][1080,2400]">
    ...
    <node index="1" text="Open" hint="Choose an order" content-desc="Open order" resource-id="com.example.app:id/open" class="android.widget.Button" clickable="true" checked="true" enabled="true" focusable="true" focused="true" password="false" bounds="[20,140][300,240]" />
  </node>
</hierarchy>`;
